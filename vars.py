...
#Auto Forward vars
FROM_DB = [int(channel_id) for channel_id in environ.get('FROM_DB', '-1002552806781 -1002031007752 -1001676473152 -1001307877241 -1002565856677').split() if re.match(r'^-?\d+$', channel_id)]
